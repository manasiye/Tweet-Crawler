...
public class GetChirpsDE {
	Twitter twitter;
	//This is sample search String. Can be modified as per use.  	
	String searchString = "Syria, OR ISIS, OR Paris #prayforparis OR #parisattacks OR #syria lang:de since:2015-12-06 until:2015-12-07 -filter:retweets";
    List<Status> tweets;
    int totalTweets;
 ...
 ArrayList getObjList(JSONArray jarray, String prop) {
    ...
    void getNewTweets(){
        try{
            ...
            PrintWriter writer = new PrintWriter("chirps_de_Dec6b.json", "UTF-8");
            writer.println("[");
    ...
    public static void main(String[] args) {
        GetChirpsDE TwitterGetObj = new GetChirpsDE();
        TwitterGetObj.setup();
    }
